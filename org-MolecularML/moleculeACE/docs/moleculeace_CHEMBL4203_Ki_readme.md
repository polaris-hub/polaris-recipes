## Background
This dataset comprises collected and curated bioactivity data for the target CMGC protein kinase CLK family from ChEMBL assay CHEMBL4203, utilized to evaluate the performance of various machine learning algorithms on activity cliffs. We employed classical machine learning methods combined with common molecular descriptors, as well as neural networks based on unstructured molecular data such as molecular graphs or SMILES strings.
